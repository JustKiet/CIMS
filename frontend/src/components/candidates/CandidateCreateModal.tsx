...
import { candidateAPI, expertiseAPI, fieldAPI, levelAPI, areaAPI, headhunterAPI, Gender } from '@/lib/api'
import type { CandidateCreate, ExpertiseResponse, FieldResponse, LevelResponse, AreaResponse, HeadhunterResponse } from '@/lib/api'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        setError('Có lỗi xảy ra khi tạo ứng viên')
      }
    } finally {
      setLoading(false)
    }
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50" style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>
      <div ref={modalRef} className="bg-white rounded-lg w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-xl font-semibold text-gray-900">Tạo ứng viên mới</h2>
          <button
            onClick={onClose}
