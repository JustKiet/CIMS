...
import { CustomerSortField, CustomerSortOrder, CustomerSortOption } from '@/hooks/useCustomers'
...
interface CustomerHeaderProps {
  ...
  onSortChange: (option: CustomerSortOption) => void
  onSearch: () => void
  loading?: boolean
}

const sortOptions: { field: CustomerSortField; label: string }[] = [
  { field: 'name', label: 'Tên khách hàng' },
  { field: 'customer_id', label: 'Mã khách hàng' },
  { field: 'representative_name', label: 'Tên đại diện' },
  { field: 'representative_email', label: 'Email đại diện' },
]
...
export const CustomerHeader: React.FC<CustomerHeaderProps> = ({
  ...
  const handleSortOptionClick = (field: CustomerSortField, order: CustomerSortOrder) => {
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4 flex-1">
          ...
          <div className="relative flex-1 max-w-3xl">
            ...
            <Input
              type="text"
              placeholder="Tìm kiếm theo tên khách hàng, email, hoặc tên đại diện..."
              value={searchQuery}
